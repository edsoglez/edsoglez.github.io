...
userButton.addEventListener('click',()=>{
    ...
    userButton.style.backgroundColor= 'rgba(255, 255, 255, 0.85)'; 
    userButton.style.color= 'rgba(0, 0, 0, 1)'; 
...
userButton.addEventListener('blur',()=>{
    ...
    userButton.style.color= 'rgba(1, 1, 1, 1)'; 
...
filterButton.addEventListener('focus',()=>{
    ...
    filterButton.style.backdropFilter= 'blur(1000px)'; 
    filterButton.style.backgroundColor= 'rgba(255, 255, 255, 0.85)'; 
    filterButton.style.color= 'rgba(0, 0, 0, 1)'; 
...
filterButton.addEventListener('blur',()=>{
    ...
    filterButton.style.color= 'rgba(1, 1, 1, 1)'; 
